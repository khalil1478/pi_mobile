...
//-- DON'T EDIT ABOVE THIS LINE!!!
    ...
    private void showData(testForm form) {
    ...
    private void showIfNotLoggedIn(testForm form) {
    ...
    private void showIfLoggedIn(testForm form) {
        String token = (String) Storage.getInstance().readObject("token");
    ...
    private void facebookLogout(testForm form) {
    ...
    private void facebookLogin(testForm form) {
        //use your own facebook app identifiers here   
        //These are used for the Oauth2 web login process on the Simulator.
        String clientId = "268396754350896";
        String redirectURI = "http://localhost/"; //Una URI cualquiera. Si la pones en tu equipo debes crear un Servidor Web. Yo usé XAMPP
        String clientSecret = "0760a5232f4218f95d63b3540ed23c39";
        Login fb = FacebookConnect.getInstance();
        fb.setClientId(clientId);
        fb.setRedirectURI(redirectURI);
        fb.setClientSecret(clientSecret);
